...
<!-- In the first sentence we used $..$ to have the variables as mathematical
     ...
     Since \begin{equation} and \end{equation} are a bit long to frequently
     type, in the second equation we use the simpler \eb and \ee. These are just
     new commands that I created in the file preamble.tex - take a quick look at
     that file to see. -->
