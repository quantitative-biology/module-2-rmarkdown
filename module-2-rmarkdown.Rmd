...
```{r, echo = FALSE, fig.cap = "First example page showing multiple figures of data.", fig.alt = "Screenshot of a page with a complex layout of 23 figures.", width="100%"}
knitr::include_graphics("silvergray-rockfish-1.png")
```

and

```{r, echo = FALSE, fig.cap = "Second example page showing multiple figures of data.", fig.alt = "Second example page showing further figures of data.", width="100%"}
...
```{r plot, fig.cap = "Simple plot of the 50 simulated data points.", fig.alt = "Simple plot of the 50 simulated data points."}
plot(x, y)
```
...
And create a plot:
```{r plotfit, fig.cap = "Simple plot of the 50 simulated data points with the fitted regression added in red.", fig.alt = "Same simple plot with simple regression line added."}
plot(x, y)
abline(fit, col="red")
```
...
```{r, echo = FALSE, fig.cap = "Screenshot showing how to knit in RStudio.", fig.cap = "Screenshot highlighting the knit button in RStudio.", width="100%"}
knitr::include_graphics("Step_1_Knit.png")
```

and then select the format with

```{r, echo = FALSE, fig.cap = "Screenshot showing how to select knit output in RStudio.", "Screenshot showing knit options in RStudio.", width="100%", fig.align = "center"}
...
```{r, echo = FALSE, fig.cap = "Screenshot showing how to open .html file in RStudio.", fig.cap = "Screenshot highlighting the open in browser button in RStudio.", width="100%"}
...
```{r, echo = FALSE, fig.cap = "Screenshot showing how to run a chunk in RStudio.", fig.alt = "Screenshot highlighting the green triangle run a chunk in RStudio.", width="100%"}
...
```{r, echo = FALSE, fig.cap = "Screenshot showing how to run all code preceding a chunk.", fig.alt = "Screenshot showing the green rectangle to click to run all code preceding a chunk.", width="100%"}
