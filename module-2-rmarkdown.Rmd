...
1. The file is an Rmarkdown (`.Rmd`) file that you can run by either clicking
...
That last bit is the crux of `Rmarkdown`. Once you understand that then you
...
the simple instructions another book by Yhiui Xie et al., the [Rmarkdown
...
using `Rmarkdown`. The [Definitive Guide to
Rmarkdown](https://bookdown.org/yihui/rmarkdown) is highly recommended (and
