...
```{r, echo = FALSE, fig.alt = "Screenshot showing how to knit in RStudio.", width="100%"}
knitr::include_graphics("Step_1_Knit.png")
```

and then select the format with

```{r, echo = FALSE, fig.alt = "Screenshot showing how to select knit output in RStudio.", width="100%", fig.align = "center"}
...
```{r, echo = FALSE, fig.alt = "Screenshot showing how to open .html file in RStudio.", width="100%"}
...
```{r, echo = FALSE, fig.alt = "Screenshot showing how to run a chunk in RStudio.", width="100%"}
...
```{r, echo = FALSE, fig.alt = "Screenshot showing how to run all code preceding a chunk.", width="100%"}
